...
const DEFAULTS: Array<Pick<SupplyRow, 'skey' | 'label' | 'intervalDays' | 'notifyHour' | 'notifyMinute'>> = [
  ...
  { skey: 'Hose',             label: 'Hose ⚕️',             intervalDays: 90,  notifyHour: 21, notifyMinute: 0 },
  { skey: 'Water Supply',     label: 'Water Supply 🚰',    intervalDays: 180, notifyHour: 21, notifyMinute: 0 },
  { skey: 'Filter',           label: 'Filter 🌬️',          intervalDays: 14,   notifyHour: 21, notifyMinute: 0 },
  { skey: 'Distilled Water',  label: 'Distilled Water 💧', intervalDays: 14,  notifyHour: 17, notifyMinute: 0 },
